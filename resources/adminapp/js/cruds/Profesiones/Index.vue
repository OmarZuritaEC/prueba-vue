      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary card-header-icon">
            ...
            <h4 class="card-title">Profesiones Table</h4>
          </div>
          <div class="card-body">
            <router-link
...
export default {
  data() {
    return {
      ...
      xprops: {
        module: 'ProfesionesIndex',
        route: 'profesiones',
        permission_prefix: 'profesione_'
      }
    }
  },
  beforeDestroy() {
  ...
  computed: {
    ...mapGetters('ProfesionesIndex', ['data', 'total', 'loading'])
  },
  watch: {
    query: {
      handler(query) {
